...
if __name__ == '__main__':
    ...
    parser.add_argument("folder_list",help="list of folders to work on")
    args = parser.parse_args()
    print(args)
    list_of_files=args.folder_list
    ...
    json_v='all_possible_features_and_values.json'
    with open(json_v) as data_file:
    ...
    path_set="/data/cwshea/ml_cmsc_678/MalwareTrainingSets/trainingSets"
    destination_dir="data/cwshea/ml_cmsc_678/normalized_datasets"
